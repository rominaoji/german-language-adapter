...
def load_and_prepare_dataset():
    dataset = load_dataset('GermanEval/germeval_14', trust_remote_code=True)
...
def main():
    ...
    logger.info(f"German NER Full fine-tuning")
    ...
    logger.info(f"German NER Full fine-tuning completed")
