...
def train_and_evaluate_kfold(train_dataset, validation_dataset, test_dataset, raw_datasets):
    k = 10
...
def main():
    print(f"German QA Full Fine Tune")
    ...
    all_val_metrics, all_test_metrics = train_and_evaluate_kfold(
        train_dataset, validation_dataset, test_dataset, raw_datasets
    )
