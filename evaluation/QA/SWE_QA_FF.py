...
def load_and_prepare_dataset():
    raw_datasets = load_dataset('alexandrainst/scandi-qa', 'sv')
...
def train_and_evaluate_kfold(train_dataset, validation_dataset, test_dataset, raw_datasets):
    ...
    for fold, (train_index, val_index) in enumerate(kf.split(train_dataset)):
        ...
        val_metrics = compute_metrics(
            val_start_logits, val_end_logits, validation_dataset, raw_datasets["val"]
        )
...
def main():
    ...
    all_val_metrics, all_test_metrics = train_and_evaluate_kfold(train_dataset, validation_dataset, test_dataset, raw_datasets)
